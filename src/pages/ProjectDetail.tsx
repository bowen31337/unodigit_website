    ...
    >
      ...
      <section ref={heroRef} className="relative py-20 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <Link to="/work" className="inline-flex items-center gap-2 text-muted hover:text-primary transition-colors mb-8">
              ...
              <div className="sticky top-32">
                ...
                <div className="space-y-4">
                  {allProjects
                    ...
                    .slice(0, 3)
                    .map(related => (
                      <Link key={related.slug} to={`/work/${related.slug}`} className="block group">
